...
echo "Checking VPS"
IZIN=$( curl https://raw.githubusercontent.com/R2GANTENG/permission/main/ipvps | grep $MYIP )
if [ $MYIP = $MYIP ]; then
echo -e "${NC}${GREEN}Permission Accepted...${NC}"
else
echo -e "${NC}${RED}Permission Denied!${NC}";
echo -e "${NC}${LIGHT}Please Contact Admin!!"
echo -e "${NC}${LIGHT}Facebook : Raden Rizki"
echo -e "${NC}${LIGHT}WhatsApp : 083876103562"
